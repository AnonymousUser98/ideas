...
> [!IMPORTANT]
> Turns out it's impossible to make this work on unmodded consoles (unless there's a Root CA data breach, which almost certainly won't heppen).
...
#### Game Demos
> [!NOTE]
> An official asset exists for this button. It can be found in the template I created: [menu-promo/Promo_demos.jpg](https://github.com/AnonymousUser98/NintendoZoneTemplate/blob/main/menu-promo/Promo_demos.jpg)
